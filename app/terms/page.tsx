...
export const metadata: Metadata = {
  ...
  description: "Terms and Conditions for using Veil Research platform.",
}
      ...
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "80px 24px 120px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "48px" }}>
          ...
          <Section title="1. Acceptance of Terms">
            <P>By accessing or using Veil Research ("Veil", "we", "our", "us") at veilresearch.com, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use the platform.</P>
            <P>These Terms apply to all visitors, users, and others who access or use the platform. By creating an account, you represent that you are at least 13 years of age and have the legal capacity to enter into these Terms.</P>
          </Section>

          <Section title="2. Description of Service">
            <P>Veil Research is an AI-powered research workspace that provides access to large language models, research workflows, and productivity tools for researchers, students, and ML engineers. The platform includes four specialized modes: Research, Biology, Flywheel, and Write.</P>
            <P>We reserve the right to modify, suspend, or discontinue the service at any time, with or without notice. We shall not be liable to you or any third party for any modification, suspension, or discontinuation of services.</P>
          </Section>
          ...
          <Section title="4. Free Trial">
            <P>Veil offers a limited free trial that allows each registered user to send one (1) free message per supported AI model (currently four models), for a total of four free interactions. This trial is provided per account, non-transferable, and cannot be reset by creating a new account with the same email address.</P>
            <P>After exhausting the free trial, continued access to the platform requires an active paid subscription. We reserve the right to modify or discontinue the free trial at any time.</P>
          </Section>

          <Section title="5. Subscriptions and Billing">
            <P>Veil offers the following subscription plans:</P>
            <ul style={{ paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px", color: "#7878a8", fontSize: "15px", lineHeight: "1.7" }}>
              <li><strong style={{ color: "#ededff" }}>Early Access</strong> — ₹199/month (limited availability; price locked for life of subscription)</li>
            ...
            <P>All payments are processed securely through Razorpay. By subscribing, you authorize Razorpay to charge your payment method on a recurring basis. Subscriptions automatically renew unless cancelled before the renewal date.</P>
            <P>Early Access pricing is guaranteed for the life of your continuous subscription. If you cancel and resubscribe, standard pricing applies.</P>
            <P><strong style={{ color: "#ededff" }}>Refunds:</strong> We offer a 7-day refund policy on first-time subscriptions if you have not used the platform extensively. Refund requests must be sent to vibhorpandey09@gmail.com within 7 days of the charge. Subsequent billing cycles are non-refundable.</P>
          </Section>
          ...
          <Section title="6. Acceptable Use">
            ...
            <ul style={{ paddingLeft: "20px", display: "flex", flexDirection: "column", gap: "8px", color: "#7878a8", fontSize: "15px", lineHeight: "1.7" }}>
              ...
              <li>Generate, distribute, or promote misinformation, spam, or deceptive content</li>
              <li>Attempt to bypass subscription limits, trial restrictions, or authentication systems</li>
          ...
          <Section title="7. AI-Generated Content">
            <P>Veil provides access to AI language models operated by third parties including OpenAI and NVIDIA. AI-generated outputs may be inaccurate, incomplete, or inappropriate. You are solely responsible for verifying and validating any AI-generated content before use.</P>
            <P>We do not claim ownership of content you submit to or receive from the AI models. However, you grant us a limited, non-exclusive license to process your inputs as necessary to provide the service.</P>
          ...
          <Section title="9. Third-Party Services">
            <P>Veil integrates with third-party services including but not limited to OpenAI, NVIDIA, Supabase, Razorpay, Resend, GitHub, Hugging Face, and Weights &amp; Biases. Use of these services is subject to their respective terms and privacy policies. We are not responsible for the practices, availability, or content of third-party services.</P>
          </Section>
          ...
          <Section title="10. Disclaimer of Warranties">
            ...
            <P>We make no warranties regarding the accuracy, reliability, or completeness of AI-generated content. Research outputs from Veil should be independently verified before reliance.</P>
          </Section>
          ...
          <Section title="12. Termination">
            <P>You may terminate your account at any time by contacting us at vibhorpandey09@gmail.com or through your dashboard settings. Upon termination, your access to paid features will continue until the end of the current billing period.</P>
          ...
          <Section title="13. Governing Law">
            <P>These Terms shall be governed by and construed in accordance with the laws of India. Any disputes arising under or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts of Dehradun, Uttarakhand, India.</P>
          </Section>
